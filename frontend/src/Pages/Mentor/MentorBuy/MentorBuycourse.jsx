                        ...
                        <div className="border p-3 rounded">
                            ...
                            <div className="mb-3">
                                ...
                                <p className="d-flex justify-content-between">
                                    ...
                                    <span>₹ {discount.toFixed(2)}</span> {/* Display total discount */}
                                </p>
                                <p className="d-flex justify-content-between">
                                    <span>Total After Discount:</span>
                                    <span>₹ {priceAfterDiscount.toFixed(2)}</span> {/* Display total after discount */}
                                </p>
                                <p className="d-flex justify-content-between">
                                ...
                                <p className="d-flex justify-content-between">
                                    ...
                                    <strong>
                                        ₹ {isCheckoutSuccess ? totalAmountWithGST.toFixed(2) : subtotal.toFixed(2)}
                                    </strong>
                                </p>
                            </div>
...
export default MentorBuycourse;